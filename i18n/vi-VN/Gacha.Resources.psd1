@{
    BlankLine = ""
    Greeting = "Chào mừng đến Menu Thu Thập URL Nhật Ký Gacha!"
    RegRememberChoice = "Ghi nhớ lựa chọn ngôn ngữ này cho lần sau không? (y/n)"
    ...
    GachaMenuTitle = "Menu Thu Thập URL Nhật Ký Gacha"
    GachaMenuDescription = "Chọn trò chơi:"
    GachaMenuOptions = @("1. Genshin Impact", "2. Honkai: Star Rail", "3. Zenless Zone Zero", "4. Cài đặt", "Nhấn [0] để thoát")
    GachaMenuAnyKey = "Nhấn bất kỳ phím nào để tiếp tục..."
    GachaMenuExit = "Dọn file rác và thoát..."
    GachaMenuChooseLink = "Chọn vùng:"
    RegionOptions = @("1. Quốc tế", "2. Trung Quốc Đại Lục", "3. Bản Cloud", "Nhấn [0] để thoát")
    RegionOptionsNoCloud = @("1. Quốc tế", "2. Trung Quốc Đại Lục", "Nhấn [0] để thoát")
    CloudOptions = @("1. Quốc tế", "2. Trung Quốc Đại Lục", "Nhấn [0] để thoát")
