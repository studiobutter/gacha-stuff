@{
    ...
    CleanerOptions = @("1.未侦测到启动器", "2. HoYoPlay 启动器", "3.Collapse 启动器", "4.云启动器", "?.了解更多", "按 0 退出")
    ...
    ToolCleanerDisclaimer3 = @("Example", "- Genshin Impact (China) and Genshin Impact (BiliBili)", "- Honkai: Star Rail (China) and Honkai: Star Rail (BiliBili)", "- Zenless Zone Zero (China) and Zenless Zone Zero (BiliBili)", "- Genshin Impact (Global) and Genshin Impact (Global) - Google Play)")
