@{
    ...
    GachaMenuOptions = @("1. Genshin Impact", "2. Honkai: Star Rail", "3. Zenless Zone Zero", "4. Settings", "Press 0 to Exit")
    ...
    RegionOptions = @("1. Global", "2. China", "3. Cloud", "Press 0 to Exit")
    RegionOptionsNoCloud = @("1. Global", "2. China", "Press 0 to Exit")
    CloudOptions = @("1. Global", "2. China", "Press 0 to Exit")
